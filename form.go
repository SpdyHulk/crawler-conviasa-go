...
func init() {
	...
	FormData.Add("COMMERCIAL_FARE_FAMILY_1", "ARGENTINA")
	FormData.Add("PRICING_TYPE", "I")
	FormData.Add("SEVEN_DAY_SEARCH", "TRUE")
	FormData.Add("B_LOCATION_1", "CCS")
	FormData.Add("E_LOCATION_1", "EZE")
	FormData.Add("B_LOCATION_2", "EZE")
	FormData.Add("E_LOCATION_2", "CCS")
	FormData.Add("B_DATE_1", "201702021200")
	FormData.Add("B_DATE_2", "201702090000")
	...
	FormData.Add("ORIGEN", "CCS")
	FormData.Add("DESTINO_VISUALIZAR", "Buenos Aires (EZE), AR")
	FormData.Add("DESTINO", "EZE")
	FormData.Add("fecha_desde", "02/02/2017")
	FormData.Add("fecha_hasta", "09/02/2017")
